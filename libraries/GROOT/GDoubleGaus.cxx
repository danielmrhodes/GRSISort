...
Bool_t GDoubleGaus::Fit(TH1 *fithist,double cent1,double cent2,Option_t *opt) {
  ...
  fArea1 = gaus1pars[0]*gaus1pars[2]*TMath::Sqrt(2.0*TMath::Pi()) / fithist->GetBinWidth(1);
  fArea2 = gaus2pars[0]*gaus2pars[2]*TMath::Sqrt(2.0*TMath::Pi()) / fithist->GetBinWidth(1);
  ...
  fDSumTotal = TMath::Sqrt(fSumTotal) + TMath::Sqrt(bgArea);
